  ...
  return (
    <div className={`min-h-screen flex ${fondo}`}>
      ...
      <main className="flex-1 p-12 space-y-12">
        {/* Header con fondo morado claro y texto negro */}
        <header className="rounded-3xl p-10 shadow-xl bg-indigo-200 border border-indigo-300 text-gray-900">
          <p className="text-sm font-medium mb-1">Bienvenido/a</p>
        ...
        <section className={`${tarjeta} rounded-2xl p-8`}>
          ...
          <div className="flex gap-4 flex-wrap">
            <button
              ...
              className="px-5 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-900"
            >
              {altoContraste
          ...
          <div className="mt-4 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {clases.map((clase) => (
              <div
                ...
                className={`${tarjeta} rounded-2xl shadow-lg hover:shadow-2xl cursor-pointer transition`}
              >
                {/* CABECERA MORADA DE LA TARJETA */}
                <div className="bg-indigo-200 p-4 rounded-t-2xl flex justify-between items-center">
